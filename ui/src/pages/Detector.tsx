        ...
        <div className="flex items-center justify-between">
          <div className="text-center flex-1 space-y-4">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              ...
              analysis. Upload a video and get detailed insights into
              personality dimensions through facial expressions and behavior.
            </p>
          </div>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handlePersonDataChange("name", e.target.value)
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handlePersonDataChange("age", e.target.value)
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handlePersonDataChange("gender", e.target.value)
                      }
                ...
                {detectMutation.error && (
                  <Alert className="border-red-200 bg-red-50">
                    <AlertDescription className="text-red-700">
                      Video analysis failed. Please try again with a clear face
                      video.
                    </AlertDescription>
                  </Alert>
                )}
                ...
                <CardContent>
                  <div className="grid gap-6">
                    {oceanTraits.map((trait) => {
                      ...
                      const value =
                        detectMutation.data.results[
                          trait.key as keyof OceanResult
                        ];
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                              <div
                                className={`p-2 rounded-lg ${trait.gradient}`}
                              >
                                <Icon className="w-4 h-4 text-white" />
                              </div>
                              <div>
                                <h3
                                  className={`font-semibold ${trait.textColor}`}
                                >
                                  {trait.label}
                                </h3>
                            ...
                            <div className="text-right">
                              <div
                                className={`text-2xl font-bold ${trait.textColor}`}
                              >
                                {value}%
                              </div>
                              <Badge
                        ...
                        <div className="grid grid-cols-5 gap-1">
                          {oceanTraits.map((trait) => (
                            <div key={trait.key} className="text-center">
                              <div
                                className={`text-xs font-medium ${trait.textColor}`}
                              >
