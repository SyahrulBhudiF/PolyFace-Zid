...
from services.polyfacemodel import create_model_polyface3, wrap_polyface_tf
from services.polyfacemodels2 import create_model_polyface3, wrap_polyface_tf

# --- Config ---
UPLOAD_FOLDER = 'static/uploads'
FACE_FOLDER = 'static/faces'
MODEL_WEIGHTS = 'models/1127_145313/polyface.t5'
# MODEL_WEIGHTS = 'model/polyfacemodel_adagrad'
...
def predict_ocean_from_faces(face_dir):
    ...
    for file in face_files:
        img = Image.open(os.path.join(face_dir, file)).resize((112, 112)).convert("RGB")
